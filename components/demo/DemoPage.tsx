...
This lesson may be used to:
       ...
       <p
          className={`${robotoopo.className} text-base text-base  text-xl sm:text-2xl md:text-3xl mt-4 sm:mt-8 sm:mb-10`}
        >
       Piloting <strong><i>Myths & Reality</i></strong> allows districts to experience the structure, tone, and educational outcomes of Walking Wise before fully {" "}
        <a className="underline" href="https://www.walkingwise.com/implementation" target="_blank">implementing</a> the program.  </p>
      </Section>
