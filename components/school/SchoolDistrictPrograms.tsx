...
<div className={`grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 my-10 gap-6 md:gap-10 items-center`}>
            ...
            <div     className={`bg-[#00c1d5] mx-auto w-full max-w-[400px] flex px-0 pb-8 pt-0 items-center flex-col`} >
              <div   className={`flex justify-between px-4 sm:px-6 py-4 mb-6 md:px-2 xl:px-8 w-full bg-[#303030]`}>
                ...
                <h1 className={`text-2xl sm:text-4xl font-bold mb-2 text-white`}>
                  ...
                  <svg  style={`stroke: rgb(255, 255, 255); fill: rgb(255, 255, 255); width: 1275.58px; height: 9px;`}>
                  <path d="M0,4.5L1275.5821399412046,4.5" stroke-linecap="butt" 
                  stroke-width="42.666666666666664" fill="none" pointer-events="auto" opacity="0" 
                  className={`_682gpw`} 
                  ></path><g>
                  <path d="M0,4.5L1275.5821399412046,4.5" stroke-linecap="butt" 
                  stroke-width="9" fill="none" pointer-events="none"></path></g></svg>
