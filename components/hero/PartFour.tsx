...
const cardData: CardProps[] = [
  ...
  },
  {
    ...
    description:
      "Our 12 learning modules can be integrated into your organization’s training platform or accessed by your associates online via a Walking Wise enterprise subscription.",
...
const PartFour: React.FC = () => {
  return (
    <div style={{ backgroundColor: "#00c1d5" }}>
      <div className="w-full flex flex-col lg:flex-row text-white justify-center items-center lg:items-stretch gap-8 px-4 sm:px-10 lg:px-20 py-24">
        {cardData.map((card) => (
          <Card
            key={card.altText}
